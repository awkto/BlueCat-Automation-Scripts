...
try:
    ...
    blk = entity(bam, 'getIPRangedByIP', 'containerId='+str(config.attr('id')[0])+'&type=IP4Network&address='+str(cidr))
    if not blk.objs:
        raise Exception("Network " + block + " does not exist")
    ...
    print ('successfuly updated network : ' + block + ' with name : ' + new_name)
